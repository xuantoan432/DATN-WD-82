                        ...
                        <div class="product-info-content" data-aos="fade-left">
                            ...
                            <div class="price">
                                ...
                                @if(!empty($priceSales))
                                    ...
                                    @endphp
                                    <span
                                        class="price-cut">₫{{ number_format($minRegularPrice, 0, ',', '.') }} - ₫{{ number_format($maxRegularPrice, 0, ',', '.') }}</span>
                                    <span
                                        class="new-price">₫{{ number_format($minSalePrice, 0, ',', '.') }} - ₫{{ number_format($maxSalePrice, 0, ',', '.') }}</span>
                                @else
                                    <span
                                ...
                                <div class="product-quantity">
                                    <div class="quantity-wrapper">
                                        ...
                                        <span class="minus">
                                            ...
                                            <input type="text" class="number" id="quantity" value="1" name="quantity">
                                            <span class="plus">
                                            +
                                        </span>
                                        </div>
