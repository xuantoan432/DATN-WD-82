                    ...
                    <div class="col-md-6">
                        <div class="product-info-content" data-aos="fade-left">
                            ...
                            <div class="price">
                                ...
                                @if(!empty($priceSales))
                                    @php
                                        $minSalePrice = !empty($priceSales) ? min($priceSales) : min($priceRegulars);
                                        $maxSalePrice = !empty($priceSales) ? max($priceSales) : max($priceRegulars);
                                    @endphp
                                    <span
                                        class="price-cut"> ₫{{ number_format($minSalePrice, 0, ',', '.') }} - ₫{{ number_format($maxSalePrice, 0, ',', '.') }}</span>
                                @endif
                                <span
                                    class="new-price">₫{{ number_format($minRegularPrice, 0, ',', '.') }} - ₫{{ number_format($maxRegularPrice, 0, ',', '.') }}</span>
                            </div>
                            <p class="content-paragraph">{{ $product->short_description }}</p>
                            <hr>
                            <div class="product-availability">
                                <span>Có sẵn : </span>
                                <span class="inner-text">{{ $product->variants()->sum('stock_quantity') }} Sản phẩm có sẵn</span>
                            </div>
                                        ...
                                        <div class="attribute-options">
                                            @foreach($attribute['values'] as $id => $value)
                                                <label class="attribute-option"
                                                       for="atttributeValue[{{$key}}][{{ $id }}]">
                                                    <input type="radio" id="atttributeValue[{{$key}}][{{ $id }}]"
                                                           name="atttributeValue[{{$key}}][{{ $id }}]" value="1"/>
                                ...
                                <div class="modal-wrapper action">
                                    ...
                                    <div class="login-section account-section modal-main">
                                        <div class="review-form">
                                            ...
                                            <div class="review-form-name address-form">
                                                <label for="reportnote" class="form-label">Enter Report
                                                    Note*</label>
        ...
        <div class="container">
            <div class="product-detail-section">
                ...
                <div class="tab-pane fade" id="nav-seller" role="tabpanel" aria-labelledby="nav-seller-tab"
                     tabindex="0">
                    <div class="seller-info-section" data-aos="fade-up">
                        <div class="logo">
                            <img src="{{ asset('theme/client/assets/images/logos/avatar.jpg') }}" alt="">
                        </div>
                        <div class="desc">
                            <div class="name-shop">{{ $product->seller->store_name }}</div>
                            <div class="action">
                                <a href="#"><i class="fab fa-rocketchat"></i>Chat ngay</a>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="theme/client/assets/images/homepage-one/product-img/product-img-5.webp"
                                     alt="product-img">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="theme/client/assets/images/homepage-one/product-img/product-img-6.webp"
                                     alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                    <span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="theme/client/assets/images/homepage-one/product-img/product-img-9.webp"
                                     alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                    <span>
