            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    <div class="product-img">
                        <img src="/storage/uploads/products/{{$product->image}}"
                            alt="product-img">
                        <div class="product-cart-items">
                            ...
                            <a href="{{ route('home.wishlist', $product->id) }}" class="favourite cart-item">
                                <span>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="{{ route('home.compaire', $product->id) }}" class="compaire cart-item">
                                <span>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect width="40" height="40" rx="20" fill="white" />
                    ...
                    <div class="product-info">
                        <div class="ratings">
                            @php
                                $rating = round($product->reviews_avg_star);
                            @endphp
                            @for ($i = 1; $i <= 5; $i++)
                                <span>
                    ...
                    <div class="product-cart-btn">
                        <a href="{{ route('home.cart', $product->id) }}" class="product-btn">Add To Cart</a>
                    </div>
                </div>
            </div>
            @endforeach
