    ...
    <div class="product-sidebar-section" data-aos="fade-up">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    <div class="product-img">
                        <img src="/storage/uploads/products/{{$np->image}}"
                            alt="product-img">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    <div class="product-img">
                        <img src="/storage/products/{{$sp->image}}"
                            alt="product-img">
                        <div class="product-cart-items">
                            <a href="#" class="cart cart-item">
                                <span>
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-description">
                            <a href="product-info.html" class="product-details">{{$sp->category->name}}
                            </a>
                            <div class="price">
                                <span class="price-cut">{{$sp->price}}</span>
                                <span class="new-price">{{$sp->price_sale}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="product-cart-btn">
