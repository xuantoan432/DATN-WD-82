                    ...
                    <div class="row">
                        <div class="col-12 col-sm-7">
                            <div class="d-flex align-items-center gap-3 mb-5">
                                <img src="{{ \Illuminate\Support\Facades\Storage::url(\Illuminate\Support\Facades\Auth::user()->avatar) }}" class="rounded-circle bg-grd-info p-1"
                                    width="60" height="60" alt="user">
                                <div class="">
                                    <p class="mb-0 fw-semibold">Welcome back</p>
                                    <h4 class="fw-semibold mb-0 fs-4 mb-0">{{ \Illuminate\Support\Facades\Auth::user()->name }}!</h4>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-5">
                            <div class="welcome-back-img pt-4">
                                <img src="{{asset('theme/admin/assets/images/gallery/welcome-back-3.png')}}" height="180"
                                    alt="">
                            </div>
                        </div>
                    </div><!--end row-->
            ...
            <div class="card w-100 rounded-4">
                ...
                <div class="card-body p-0">
                    <div class="user-list p-3">
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/01.png')}}" width="45" height="45"
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/02.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/03.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/04.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/05.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/06.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{asset('theme/admin/assets/images/avatars/08.png')}}" width="45" height="45"
                                    class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/06.png')}}"
                                                    class="rounded-circle" width="50" height="50"
                                                    alt="">
                                            </div>
