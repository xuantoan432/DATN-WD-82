        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(`.pro-${id}`).html('<span class="badge bg-success  ">Đã phê duyệt </span >')
                    $(`.duyet[data-id=${id}]`).remove();
                    $(`.tuchoi[data-id=${id}]`).remove();
...
$('#product').on('submit', function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $(`.pro-${id}`).html('<span class="badge bg-danger  ">Đã từ chối </span >')
            $(`.duyet[data-id=${id}]`).remove();
            $(`.tuchoi[data-id=${id}]`).remove();
