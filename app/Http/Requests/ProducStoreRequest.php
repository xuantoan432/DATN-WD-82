...
class ProducStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
             ...
             'giasanpham' => 'required|numeric|min:0|max:9999999999' ,
             ...
             'valuebute' => 'required' ,
            'variants.*.gia' => 'required|numeric|min:0|max:9999999999',
            'variants.*.giamgia' => 'nullable|numeric|min:0|max:9999999999',
    ...
    public function messages(): array
    {
        return [
            ...
            'max' => 'Vui lòng chỉ nhập 10 chữ  số',
            ...
            'variants.*.gia.max' => 'Giá sản phẩm không được lớn hơn 9,999,999,999.',
